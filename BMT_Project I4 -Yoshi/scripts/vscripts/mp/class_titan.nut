...
//function AddCoreEntry( entry, core_number )//TEMP, ill find something later im tired
//{
//	CoreEntry[entry] <- core_number
//}
...
/*
function SetTitanCoreForPlayer( player ) 
{
	//local titanLoadoutNumber = player.s.titanLoadoutIndex
	//local coreIndex = CoreEntry.titanloadoutNumber
	//local titanCore = Cores[coreIndex]
